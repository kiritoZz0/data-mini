...
public class Apriori{
    ...
    public static void main(String[] args){
        ...
        dataList.add("啤酒,尿布,婴儿爽身粉,面包,雨伞,");
        dataList.add("尿布,婴儿爽身粉,");
        dataList.add("啤酒,尿布,牛奶,");
        dataList.add("尿布,啤酒,洗衣粉,"); 
        dataList.add("啤酒,牛奶,可乐,");//{1-啤酒，2-尿布，3-婴儿爽身粉，4-面包，5-雨伞,6-牛奶，7-洗衣粉，8-可乐}
      ...
      /*  dataList.add("A,C,D,");
        ...
        for(String key:keySet){
        	if(key.length()<3&&frequentSetMap.get(key)>1)
        	{
        		
        		System.out.println(key.charAt(0)+" : "+frequentSetMap.get(key));
        	}
        ...
        for(String key:keySet){
        	...
        	if(key.length()>3&&key.length()<5)
        	{
        		...
        		System.out.println(key.substring(0, 3)+" : "+frequentSetMap.get(key));
        	}
        ...
        for(String key:keySet){
        	...
        	if(key.length()>5)
        	{
        		...
        		System.out.println(key.substring(0,5)+" : "+frequentSetMap.get(key));
        	}
